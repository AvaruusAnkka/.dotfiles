...
_G.packer_plugins = {
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/andy/.local/share/nvim/site/pack/packer/start/coc.nvim",
    url = "https://github.com/neoclide/coc.nvim"
  },
  ["copilot.vim"] = {
    loaded = true,
    path = "/home/andy/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["vim-prettier"] = {
    loaded = true,
    path = "/home/andy/.local/share/nvim/site/pack/packer/start/vim-prettier",
